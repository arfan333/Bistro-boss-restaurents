...
const UserHome = () => {
  ...
  // used axiosPublic to show users-home section data
  ...
  // now show the charts section using axiosPublic
  const { data: chartData = [] } = useQuery({
    queryKey: ["order-stats-allUsers"],
    queryFn: async () => {
      const res = await axiosPublic.get("/order-stats-allUsers");
      return res.data;
    },
  });
